...
export default function SearchBar({data, setData, setHideScreen}){
    ...
    useEffect(() => {
        const results = data.map((data) => {
            ...
            return {...data, 'display': searchKey != "" && (lowercase_symbol.startsWith(lowercase_key) || lowercase_name.startsWith(lowercase_key))}
        });
    ...
    return (
        <div className="relative w-full flex justify-center mt-8"  ref={containerRef}>
            <div className="relative w-full max-w-xl">
                ...
                {searchKey != "" &&
                    <div className="absolute rounded-lg shadow-xl bg-white w-full p-4 mt-1 z-10 overflow-y-auto max-h-96"> 
