...
export default function AddFavorite({onToggle, isActive, value}){
    const [, , ,userData, setUserData] = useContext(CryptoContext);
        ...
        <svg 
            ...
            onClick={async () => {
                ...
                const updatedFavorites = isActive ? 
                                                    ...
                                                    :
                                                    [...userData.favorites, value]
                
                updateUserData(userData.pk_users, {favorites: updatedFavorites.join(',')});
